...
\begin{figure}
    \begin{subfigure}{\columnwidth}
        ...
        \end{tikzpicture}
        \caption{Node B generating a concurrent \emph{rename} operation to one applied on node A}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \begin{tikzpicture}
            \path
            ...
            \draw[->, thick] (S2B.east) -- node[below right, align=center]{\emph{rename}} (S2A-left.west);
        \end{tikzpicture}
