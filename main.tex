...
Additionally, in the case of RenamableLogootSplit, from 1 to 4 bots are arbitrarily designated as \emph{renamingBots} according to the session.
\emph{RenamingBots} issue \emph{rename} operations every time they observe 30k operations overall.
