...
\begin{figure}[ht!]
    ...
    %             to ++(270:1.5) node[op] (eA8) {\epoch{A8}};
    ...
    %         \draw[thick] (e0) -- (eA1) -- (eA8);
    %         \draw[thick] (e0) -- (eB2) -- (eB7);
    %         \draw[dashed, thick, red] (eB7.130) -- (eB2.225) --node[yshift=7, above, align=center]{priority} (eA8.45) -- (eA1.315);
    %         \draw[->, dashed, thick, red] (eA1.0) -- (e0.270);

    %     \end{tikzpicture}
    %     \caption{Full state of epoch trees}
    %     \label{fig:GC-full-epoch-trees}
    % \end{subfigure}
